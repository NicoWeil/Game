/**
 * Methode zur Erzeugung eines Spielerobjekts.
 * 
...
public class Player extends Character {
     ...
     * wird der Angriff mit den normalen ATK durchgefuehrt.
     */
    ...
    /**
     * addItem() erhoeht die ANzahl der Heiltraenke um 1.
     */
    ...
    /**
     * enoughAp(int apNeeded) gibt booleanschen Wert zurueck ob genug AP
     * vorhanden sind (in Klammern uebergeben).
     * 
     * @param int apNeeded
     * @return true/false
     */
    ...
    /**
     * getBonusAtk() gibt BonusATK zurueck.
     * 
     * @return
     */
    ...
    /**
     * entersFountain() setzt HP und AP auf die maximalen Werte.
     */

    public void entersFountain() {
        this.hp = this.maxHP;
        this.ap = this.maxAp;
        System.out.println("HP und AP wieder hergestellt!");
    }

    /**
     * entersSmith() erhoet die ATK um 5.
     */

    public void entersSmith() {
        this.atk = this.atk + 5;
        System.out.println("ATK um 5 erhoeht!");
    }
}
